...
const _DEFAULT = {
  ...
  texture_options: {
    ...
    st_skin: {
      ...
      // aoMapIntensity: .1,
      // roughness: 1,
      envMapIntensity: .5 // normalMapType: THREE.ObjectSpaceNormalMap

    },
    st_hair: {
      aoMap: null // aoMapIntensity: .2,
...
$(function () {
  ...
  _avatar_main__WEBPACK_IMPORTED_MODULE_2__["avatar"].switch();
