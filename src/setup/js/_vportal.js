...
$.fn.vPortal = function(options) {
    ...
    if (
        ...
        pagination(settings.el, dataType, shortUrl, blockName, params, function(){}, settings.paginationOptions);
    }
...
var loadNews = function(
        el, page, type, dataType, shortUrl, blockName, params = "", after = () => {}, paginationOptions = {}
    ) {
